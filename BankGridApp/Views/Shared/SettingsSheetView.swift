        ...
        VStack(spacing: 16) {
            VStack(alignment: .leading, spacing: 4) {
                Text("卖出网格比例 (%)")
                    .font(.system(size: 13))
                    .foregroundColor(.themeText2)
                TextField("", value: $gridUp, format: .number.precision(.fractional(1)))
                    .keyboardType(.decimalPad)
                    .textFieldStyle(CustomTextFieldStyle())
            }
            ...
            VStack(alignment: .leading, spacing: 4) {
                Text("买入网格比例 (%)")
                    .font(.system(size: 13))
                    .foregroundColor(.themeText2)
                TextField("", value: $gridDown, format: .number.precision(.fractional(1)))
                    .keyboardType(.decimalPad)
                    .textFieldStyle(CustomTextFieldStyle())
            }
            ...
            VStack(alignment: .leading, spacing: 4) {
                Text("单次交易仓位比例 (%)")
                    .font(.system(size: 13))
                    .foregroundColor(.themeText2)
                TextField("", value: $tradeRatio, format: .number.precision(.fractional(0)))
                    .keyboardType(.decimalPad)
                    .textFieldStyle(CustomTextFieldStyle())
            }
        ...
        VStack(spacing: 16) {
            VStack(alignment: .leading, spacing: 4) {
                Text("佣金费率 (万分之)")
                    .font(.system(size: 13))
                    .foregroundColor(.themeText2)
                TextField("", value: $feeRate, format: .number.precision(.fractional(2)))
                    .keyboardType(.decimalPad)
                    .textFieldStyle(CustomTextFieldStyle())
            }
            ...
            VStack(alignment: .leading, spacing: 4) {
                Text("单笔最低佣金 (元)")
                    .font(.system(size: 13))
                    .foregroundColor(.themeText2)
                TextField("", value: $feeMin, format: .number.precision(.fractional(1)))
                    .keyboardType(.decimalPad)
                    .textFieldStyle(CustomTextFieldStyle())
            }
